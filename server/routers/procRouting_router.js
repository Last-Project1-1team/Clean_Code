...
const procRoutingService = require("../services/procRouting_service.js");

// 라우팅 등록 영역

//대메뉴 전체조회
router.get("/procRouting", async (req, res) => {
  let totalList = await procRoutingService.findAll().catch((err) => console.log(err));
